            ...
            <div class="mOption">
                <table border="1">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="category" id="category" class="fText w150">
                        </td>
                        <th scope="row">발행사 <strong class='icoequired'>필수</strong></th>
                        <td>
                            <input type="text" name="issue_entity" id="issue_entity" class="fText w150">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">제목 <strong class='icoequired'>필수</strong></th>
                        <td colspan="3">
                            <input type="text" name="title" id="title" class="fText w380">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">추천주 <strong class='icoequired'>필수</strong></th>
                        <td colspan="3">
                            <input type="text" name="recommendStock" id="recommendStock" class="fText w380">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input type="text" name="registerDate" id="registerDate" class="fText gDate datetime">
                        </td>
                    </tr>
                    </tbody>
                </table>
...
<?php
include $_SERVER["DOCUMENT_ROOT"]."/Manage/report/indexWrite_js.php";
