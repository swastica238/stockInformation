<script>
    ...
    function saveForm(){
        ...
        var pf_idx = [];
        $("input[name='pf_idx[]']").each(function(){
            pf_idx.push(this.value);
        });
        ...
        var p_idx = [];
        $("input[name='p_idx[]']").each(function(){
            p_idx.push(this.value);
        });
        ...
        var i_idx = [];
        $("input[name='i_idx[]']").each(function(){
            i_idx.push(this.value);
        });
        ...
        var f_idx = [];
        $("input[name='f_idx[]']").each(function(){
            f_idx.push(this.value);
        });
        ...
        var pf_sell_idx = [];
        $("input[name='pf_sell_idx[]']").each(function(){
            pf_sell_idx.push(this.value);
        });
        ...
        var p_sell_idx = [];
        $("input[name='p_sell_idx[]']").each(function(){
            p_sell_idx.push(this.value);
        });
        ...
        var i_sell_idx = [];
        $("input[name='i_sell_idx[]']").each(function(){
            i_sell_idx.push(this.value);
        });
        ...
        var f_sell_idx = [];
        $("input[name='f_sell_idx[]']").each(function(){
            f_sell_idx.push(this.value);
        });
        ...
        var allData = {'trace':'updateForm', 'registerDate':registerDate
            , 'pf_idx':pf_idx, 'pf_stockName':pf_stockName, 'pf_buyStrength':pf_buyStrength, 'pf_isImportant':pf_isImportant
            , 'p_idx':p_idx, 'p_stockName':p_stockName, 'p_buyStrength':p_buyStrength, 'p_isImportant':p_isImportant
            , 'f_idx':f_idx, 'f_stockName':f_stockName, 'f_buyStrength':f_buyStrength, 'f_isImportant':f_isImportant
            , 'i_idx':i_idx, 'i_stockName':i_stockName, 'i_buyStrength':i_buyStrength, 'i_isImportant':i_isImportant
            , 'pf_sell_idx':pf_sell_idx, 'pf_sell_stockName':pf_sell_stockName, 'pf_sell_Strength':pf_sell_Strength
            , 'p_sell_idx':p_sell_idx, 'p_sell_stockName':p_sell_stockName, 'p_sell_Strength':p_sell_Strength
            , 'f_sell_idx':f_sell_idx, 'f_sell_stockName':f_sell_stockName, 'f_sell_Strength':f_sell_Strength
            , 'i_sell_idx':i_sell_idx, 'i_sell_stockName':i_sell_stockName, 'i_sell_Strength':i_sell_Strength
        }
